...
O conteúdo abaixo deve ser salvo em um arquivo chamado de DE2_115.qsf.

Retire os comentários das linhas contendo os recursos que deseja usar.

Em seguida, esse arquivo deve ser importado para o projeto com a ferramenta do menu:

>   Assignments > Import Assignments

***

Nomenclatura dos pinos da FPGA utilizada na placa DE2-115.
...
# Date created = 14:03:41  September 22, 2017
#
# -------------------------------------------------------------------------- #
#
# Notes:
...
#       ClockFPGA_assignment_defaults.qdf
...
set_global_assignment -name PROJECT_CREATION_TIME_DATE "14:03:41  SEPTEMBER 22, 2017"
...
set_global_assignment -name VHDL_FILE register141.vhd
...
set_global_assignment -name VHDL_FILE ULA/slt.vhd
set_global_assignment -name VHDL_FILE ULA/or_port.vhd
set_global_assignment -name VHDL_FILE ULA/not_port.vhd
set_global_assignment -name VHDL_FILE ULA/mux_4to1.vhd
set_global_assignment -name VHDL_FILE ULA/mux_2to1.vhd
set_global_assignment -name VHDL_FILE ULA/full_adder_1bit.vhd
set_global_assignment -name VHDL_FILE ULA/unary_nor32.vhd
set_global_assignment -name VHDL_FILE ULA/full_adder.vhd
set_global_assignment -name VHDL_FILE ULA/and_port.vhd
set_global_assignment -name VHDL_FILE banco_registradores.vhd
set_global_assignment -name VHDL_FILE mux_2to1_5bits.vhd
set_global_assignment -name VHDL_FILE memoria_de_dados.vhd
set_global_assignment -name VHDL_FILE register32.vhd
set_global_assignment -name VHDL_FILE MIPS.vhd
set_global_assignment -name VHDL_FILE ula_cu.vhd
set_global_assignment -name VHDL_FILE memoria_de_inst.vhd
set_global_assignment -name VHDL_FILE conversor7Seg.vhd
set_global_assignment -name VHDL_FILE divisor.vhd
set_global_assignment -name VHDL_FILE decoder.vhd
set_global_assignment -name VECTOR_WAVEFORM_FILE Waveform.vwf
set_global_assignment -name VECTOR_WAVEFORM_FILE Waveform1.vwf
set_global_assignment -name VECTOR_WAVEFORM_FILE simulation/modelsim/Waveform3.vwf
