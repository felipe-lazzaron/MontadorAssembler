...
## Última alteração: 08/12/2009
#####################################################################
.text
# Declaração de início do segmento de texto
.globl
main
# Declaração de que o rótulo main é global
########################################
...
jr  $ra                       # volta para o "sistema operacional" 
...
# PROGRAMA ACABA AQUI. Retorna para quem chamou
...
array:
.word   0xabcdef03 0xcdefab18 0xefabcd35 0xbadcfeab 0xdcfebacd 0xfebadc77 0xdefabc53 0xcbafed45   

# Acima, o terceiro byte da segunda palavra (0xef) vira 0x10 antes de exec soma_ct

size:
.word   0x8

const:
.word   0xffffffff                     # constante -1 em complemento de 2

#
# para o trecho de teste de chamadas de subrotinas
#
var_a:
.word   0xff
#
